...
pfad = ('/automount/ags/velibor/data/gpm_2017_2018/2A.GPM.GMI.GPROF*.HDF5')
...
for i in range(0, len(pfad_gprof)):
    ...
    plot_borders(ax1)
    #plot_radar(bonnlon, bonnlat, ax1, reproject=True, cband=False, col=False)
    ...
    plot_borders(ax2)
    #plot_radar(bonnlon, bonnlat, ax2, reproject=True, cband=False, col=False)
    plt.grid(color='r')
    plt.tick_params(
        axis='both',
        which='both',
    ...
    plot_borders(ax3)
    #plot_radar(bonnlon, bonnlat, ax3, reproject=True, cband=False, col=False)
    plt.grid(color='r')
    plt.tick_params(
        axis='both',
        which='both',
    ...
    plt.savefig('/automount/ags/velibor/data/gpm_2017_2018/plot/gpm_gprof_radolan_'+r_pro+'_'+str(gpm_zeit) + '.png')
    ...
    #    mask, rwattrs, result, pfad_radolan,  gpmdprs, pfad,
