...
att = ['RX','RY','zgrids_me', 'zgrids_st', 'zgrids_co',
                ...
                'rgrids_1-5', 'rgrids_5-10', 'rgrids_>10']
...
for ij in range(len(zeit)):
    ...
    try:
        ...
        rydata, ryattrs = wradlib.io.read_RADOLAN_composite(rw_filename)
    ...
    if (RX==1 & RY==0):
        ...
        RR = wradlib.zr.z2r(Z, a=200., b=1.6)
        ploty = 1

    elif (RX==0 & RY==1):
        # Wenn kein RY vorhanden MP
        R = wradlib.trafo.idecibel(rydata)
        # Marshall and Palmer 1948
        ZZ = wradlib.zr.r2z(R, a=200., b=1.6)
        ploty = 1

    elif (RX==0 & RY==0):
        # Wenn RX und RY nicht vorhanden sind
        zgrids_me, zgrids_st, zgrids_co= -9999., -9999., -9999.
        rgrids_0,rgrids_01,rgrids_15, rgrids_510, rgrids_10 = -9999., -9999., -9999.,-9999., -9999.
        ploty = 0
        #alles daten auf nan
    ...
    radolan_array = np.array([[RX,RY,zgrids_me, zgrids_st, zgrids_co,rgrids_0, rgrids_01,
                    rgrids_15, rgrids_510, rgrids_10]])
