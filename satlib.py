...
overpasses_dpr_boxpol = {
    '0':('20140806203538', 1, 'alt'),
    '1':('20140826221000', 1, 'alt'),
    '2':('20141007023744' ,0, 'alt'),
    '3':('20141008094000', 1, 'alt'),
    '4':('20141008094500', 1, 'alt'),
    '5':('20141213141304', 0, 'alt'),
    '6':('20141217054500' ,0, 'alt'),
    '7':('20150128171500', 0, 'alt'),
    '8':('20150128172208', 0, 'alt'),
    '9':('20150225163500', 0, 'alt'),
    '10':('20150330233003', 1, 'alt'),
    '11':('20150404053404', 0, 'alt'),
    '12':('20150626214445', 1, 'alt'),
    '13':('20151015203657', 1, 'alt'),
    '14':('20151211203853', 1, 'alt'),
    '15':('20151216024501', 0, 'alt'),
    '16':('20160209103000', 1, 'alt'),
    '17':('20160601175950', 1, 'alt'),
    '18':('20161109185732', 1, 'alt'),
    '19':('20160107124707', 0, 'alt'),
    '20':('20170211152500', 0 ,'alt'),
    '21':('20170211153000', 0, 'alt'),
    '22':('20170211153000', 0, 'alt'),
    '23':('20170321043000', 0, 'alt'),
    '24':('20170519110333', 0, 'neu'),
    '25':('20170725152833', 0, 'neu'),
    '26':('20170810110333', 0, 'neu'),
    '27':('20170909021332', 0, 'neu'),
    '28':('20171002025332', 0, 'neu'),
    '28':('20171126032331', 0, 'neu'),
    '29':('20171127103334', 0, 'neu'),
    '30':('20180125170330', 0, 'neu'),
}